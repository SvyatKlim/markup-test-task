...
"use strict";
__webpack_require__.r(__webpack_exports__);
var accordion = function accordion(btn, content, container) {
  var btns = $(container).find(btn);
  btns.each(function (i, el) {
    $(el).on('click', function (ev) {
      ev.stopPropagation();
      var currentContent = $(ev.currentTarget).find(content);
      currentContent.slideToggle('fast', function () {
        $(el).toggleClass('opened');
      });
      btns.each(function (j, btn) {
        if (!$(btn).is(el)) {
          var btnContent = $(btn).find(content);
          $(btnContent).slideUp('fast', function () {
            $(btn).removeClass('opened');
          });
        }
      });
      var img = $('.js-img');
      var currentAttr = img.attr('src'),
          newAttr = "./assets/img/picture/".concat($(el).data('image'));
...
var Carousel = function Carousel(container) {
  var paginationBulletName = ['Targeted Panels', 'Whole Exome Sequencing', 'lcWGS and Microarrays'];
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_headerOnScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/headerOnScroll */ "./src/js/components/headerOnScroll.js");
...
$(document).ready(function () {
  Object(_components_headerOnScroll__WEBPACK_IMPORTED_MODULE_0__["default"])();
  Object(_components_carousel__WEBPACK_IMPORTED_MODULE_1__["default"])('.js-benefits');
  Object(_components_navMobile__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_components_accordion__WEBPACK_IMPORTED_MODULE_3__["default"])('.faq__list__item', '.content', '.faq__list');
});
